...
public class GCC810Compiler implements INativeCompiler {
    private static final String TAG = "GCCCompiler";
    private Context mContext;

    public GCC810Compiler(Context context) {
    ...
    public ShellResult compile(File[] sourceFiles) {
        ...
        File gccDir = new File(internalDir, "gcc-8.1.0");
        ...
        final File libExecBinDir = new File(gccDir, "libexec/gcc/arm-linux-androideabi/" + "8.1.0");
