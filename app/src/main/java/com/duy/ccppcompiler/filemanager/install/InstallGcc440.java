...
class InstallGcc440 extends AsyncTask<Void, CharSequence, Boolean> {
    private static final String TAG = "InstallGcc440";
    private Context mContext;
    @Nullable
    private ExtractCallback mCallback;
    private Exception exception;

    InstallGcc440(Context context, @Nullable ExtractCallback callback) {
        mContext = context;
        mCallback = callback;
    }
    ...
    protected Boolean doInBackground(Void... voids) {
        ...
        try {
            ...
            final InputStream inputStream = mContext.getAssets().open("android-gcc-4.4.0.zip");
            ...
            if (success) {
                ...
                final File binDir2 = new File(gccDir, "arm-eabi" + sep + "bin");
                final File binDir3 = new File(gccDir, "libexec" + sep + "gcc" + sep + "arm-eabi" + sep + "4.4.0");
