...
public class MenuFactory {
    ...
    private MenuFactory(Context context) {
        ...
        if (toolbarIcons == null) {
            toolbarIcons = new Integer[]{R.id.action_run, R.id.action_new_file, R.id.m_undo};
        }
