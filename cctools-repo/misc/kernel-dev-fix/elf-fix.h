...
/*
   Bionic elf.h wrapper. Required for native kernel compilation
   with bionic toolchain.
   This file included to kernel-dev-fix package for CCTools
   <http://cctools.info>
 */
