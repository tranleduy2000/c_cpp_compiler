build_build_essential_gcc_objc_fortran() {
    ...
    PKG_DEPS="busybox binutils libgcc-dev libstdc++-dev libobjc-dev libgfortran-dev gobjc gfortran make ndk-misc ndk-sysroot-\${HOSTNDKARCH}-\${HOSTNDKVERSION} cctools-examples gfortran-examples"
    c_tag ${PKG} && return
