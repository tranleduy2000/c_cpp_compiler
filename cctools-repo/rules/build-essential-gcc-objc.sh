build_build_essential_gcc_objc() {
    ...
    PKG_DEPS="busybox binutils libgcc-dev libstdc++-dev libobjc-dev gobjc make ndk-misc ndk-sysroot-\${HOSTNDKARCH}-\${HOSTNDKVERSION} cctools-examples gobjc-examples"
    c_tag ${PKG} && return
