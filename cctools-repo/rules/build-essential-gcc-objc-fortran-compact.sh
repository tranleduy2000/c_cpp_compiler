build_build_essential_gcc_objc_fortran_compact() {
    ...
    PKG_DEPS="busybox binutils-compact libgcc-compact-dev libstdc++-compact-dev libgfortran-compact-dev libobjc-compact-dev gobjc gfortran make ndk-misc ndk-sysroot-\${HOSTNDKARCH}-\${HOSTNDKVERSION} cctools-examples gfortran-examples"
    c_tag ${PKG} && return
