...
public class StaticLayoutCompat {
    ...
    public StaticLayoutCompat(StaticLayout layout) {
        this.layout = layout;
    }
    ...
    public static int getFirstVisibleLine(ScrollView scrollView, int childHeight, int lineCount)
    ...
    private int[] getLines() throws IllegalAccessException {
        Field linesField = FieldUtils.getDeclaredField(layout.getClass(), "mLines", true);
        Object o = linesField.get(layout);
        return (int[]) o;
    }
    ...
    public void updateRealLine(int startingLine, int lineCount, Layout layout, String text) {
