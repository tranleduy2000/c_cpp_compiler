...
import com.duy.ide.editor.core.content.UndoOperation;
import com.duy.ide.editor.core.content.UndoOwner;
...
import com.duy.ide.editor.core.text.style.SuggestionRangeSpan;
import com.duy.ide.editor.core.view.InputMethodManagerCompat;
import com.duy.ide.editor.core.view.ViewConfigurationCompat;
...
//            reportExtractedText();
    ...
    private boolean extractTextInternal(ExtractedTextRequest request,
        ...
        if (content != null) {
            ...
            outText.flags = 0;
            if (MetaKeyKeyListener.getMetaState(content, MetaKeyKeyListenerCompat.META_SELECTING) != 0) {
...
//        shadowView.setTextAppearance(mTextView.getContext(), R.styleable.Theme_textAppearanceLarge);
    ...
    public static class TextModifyOperation extends UndoOperation<BaseEditorView> {
        public static final ClassLoaderCreator<TextModifyOperation> CREATOR
                = new ClassLoaderCreator<TextModifyOperation>() {
...
//                    mPopupWindow.mEasyEditSpan.setDeleteEnabled(false);
                    try {
                        method.invoke(mPopupWindow.mEasyEditSpan, false);
        ...
        private boolean updateSuggestions() {
            ...
            for (int spanIndex = 0; spanIndex < nbSpans; spanIndex++) {
                ...
                if (spanIndex == 0) {
                    ...
                    try {
                        underlineColorObj = method.get(suggestionSpan);
//                    underlineColor = suggestionSpan.getUnderlineColor();
                        underlineColor = (int) underlineColorObj;
                    } catch (Throwable throwable) {
                        throwable.printStackTrace();
                    }
                }
